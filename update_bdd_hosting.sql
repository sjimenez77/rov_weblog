...
## 13/10/2014 13:59
ALTER TABLE Wine ADD author_id INT DEFAULT NULL;
ALTER TABLE Wine ADD CONSTRAINT FK_F63ECB56F675F31B FOREIGN KEY (author_id) REFERENCES User (id) ON DELETE CASCADE;
CREATE INDEX IDX_F63ECB56F675F31B ON Wine (author_id);

## 17/10/2014 10:00
ALTER TABLE Wine CHANGE image_name image_name VARCHAR(255) DEFAULT NULL;
